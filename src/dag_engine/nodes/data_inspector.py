...
def data_inspector_node(state: DagGraphState) -> dict[str, Any]:
    ...
    global_blackboard.update_global_status(
        task_id=task_id,
        new_status=GlobalStatus.PREPARING_CONTEXT,
        sub_status="正在挂载沙箱并极速嗅探数据表结构..."
    )
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    inspection_result["load_kwargs"] = {"note": "非常规格式，请参考 Schema 中的 LLM 建议编写 Pandas 读取参数"}
