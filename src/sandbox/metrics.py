...
# AST审计指标
ast_audit_fail_total = Counter(
    "ast_audit_fail_nums",
    "Total number of failed ast audits in sandbox",
    ["risk_type"]
)
...
sandbox_exec_fail_total = Counter(
    ...
    "Total number of failed sandbox executions",
    ["error_type"]
)
...
sandbox_container_create_fail_total = Counter(
    ...
    "Total number of container create failures",
    ["error_type"]
)
